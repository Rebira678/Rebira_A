  ...
  return (
    <div className="pt-24 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {skills.map((skill, i) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-6 md:p-12 border border-neutral-900 bg-neutral-900/10 hover:bg-neutral-800/20 transition-all duration-300 relative group"
          >
      ...
      <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 border-t border-neutral-900 pt-12">
        ...
        <div className="md:col-span-2 bg-neutral-900/20 p-6 md:p-12 border border-neutral-800 italic">
