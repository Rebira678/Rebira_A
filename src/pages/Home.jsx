...
export default function Home() {
  return (
    <div className="pt-24 space-y-16 md:space-y-32">
      {/* Hero Section */}
      <section>
        <motion.h2
          ...
          className="text-4xl md:text-9xl font-bold tracking-tight leading-[0.85] text-white uppercase"
        >
          Engineering <br />
        ...
        >
          ...
          <div className="mt-8 flex flex-wrap gap-8 font-mono text-[10px] tracking-widest text-neutral-500 uppercase">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
        ...
        <div className="col-span-1 md:col-span-8">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-neutral-900/30 p-6 md:p-12 border-t-2 border-white mb-12"
          >
            <h3 className="text-[10px] font-mono text-neutral-500 mb-6 tracking-widest uppercase">Philosophy</h3>
            <p className="text-xl md:text-4xl leading-tight text-neutral-200 font-light italic">
