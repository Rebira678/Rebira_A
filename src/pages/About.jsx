  ...
  return (
    <div className="pt-24 min-h-screen">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
        <div className="col-span-1 md:col-span-8">
          <header className="mb-24">
            ...
            <h1 className="text-4xl md:text-8xl font-bold tracking-tighter uppercase leading-none mb-12">
        ...
        <div className="col-span-1 md:col-span-4 md:border-l md:border-neutral-900 md:pl-12 space-y-24">
          <div>
      ...
      <motion.div
        ...
        className="mt-32 pt-12 border-t border-neutral-900 flex flex-col md:flex-row justify-between items-end gap-4"
      >
        <span className="text-[60px] md:text-[150px] font-extrabold text-neutral-900 leading-[0.7] select-none uppercase tracking-tighter">Velocity</span>
